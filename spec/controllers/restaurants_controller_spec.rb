...
RSpec.describe RestaurantsController, type: :controller do
  ...
  let(:valid_attributes) { { name: "pie and cake", address: "100 Main St., Concord, MA 12345", phone: "800-800-8080" } }
  ...
  describe "GET #index" do
    it "assigns all restaurants as @restaurants" do
      user = User.create!(name: "emilio", email: "emilio@example.com", password: "password", password_confirmation: "password")
